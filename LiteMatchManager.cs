...
public class LiteMatchConfig : BasePluginConfig
{
    ...
    public List<DuelModeConfig> MatchModes { get; set; } = [
        ...
        // ★ 步槍階段的 WinLimit 請在 json 設大於 30 的數字 (如 99)
...
public class LiteMatchManager : BasePlugin, IPluginConfig<LiteMatchConfig>
{
    ...
    {
        Console.WriteLine("=================================================");
        Console.WriteLine("  LiteMatchManager (無縫HUD + 原生30勝結算版) 啟動！");
        Console.WriteLine("=================================================");
        ...
        // ★ 核心補回：確保伺服器達到總分 30 勝跳出結算時，捕捉並執行換圖！
    ...
    {
        player.PrintToChat($" {ChatColors.Orange} 在 聊 天 欄 位 輸 入 您 要 的 武 器，以 下 是 常 用 武 器");
        player.PrintToChat($" ---------------------------------------------------------------");
