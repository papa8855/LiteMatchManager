...
public class LiteMatchManager : BasePlugin, IPluginConfig<LiteMatchConfig>
{
    ...
    public override string ModuleDescription => "純版 + 30勝免死金牌 (完美防卡圖) + 轉發聊天 + 雙重HUD支援";
    ...
    {
        // ==========================================
        // 【修改處】全新回合開始 HUD 顯示邏輯 (無節流，完全照搬 ServerGraphic)
        // ==========================================
